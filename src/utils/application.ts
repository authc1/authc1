  ...
  try {
    ...
    switch (providerName) {
      case "discord":
        ...
        providerSettingsForProvider["scope"] =
          providerSettings.discord_scope;
        break;
      case "facebook":
        providerSettingsForProvider["provider_enabled"] =
        ...
        providerSettingsForProvider["scope"] =
          providerSettings.facebook_scope;
        break;
      case "apple":
        providerSettingsForProvider["provider_enabled"] =
          providerSettings.apple_provider_enabled;
        providerSettingsForProvider["team_id"] =
          providerSettings.apple_team_id;
        providerSettingsForProvider["key_id"] =
          providerSettings.apple_key_id;
        providerSettingsForProvider["client_id"] =
      ...
      case "linkedin":
        ...
        providerSettingsForProvider["scope"] =
          providerSettings.linkedin_scope;
        break;
      case "spotify":
        providerSettingsForProvider["provider_enabled"] =
        ...
        providerSettingsForProvider["scope"] =
          providerSettings.spotify_scope;
        break;
      case "twitter":
        providerSettingsForProvider["provider_enabled"] =
        ...
        providerSettingsForProvider["scope"] =
          providerSettings.twitter_scope;
        break;
      case "twitch":
        providerSettingsForProvider["provider_enabled"] =
